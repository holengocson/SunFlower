...
class ChangeEmail extends React.Component {
    ...
    onChangePasswordPress = () => {
        ...
        if(currentPassword == '' && newPassword == ''){
            ...
            Alert.alert('Please enter new email')
        }else{
            this.showLoading()
    ...
    showAlertEmailWasChanged() {
        Alert.alert(
            'Confirmation',
            'Email was changed. We recommend you should re-signin.',
            [
                ...
                { text: 'OK', style: 'default', onPress: () => this.signOut() },
            ],
            { cancelable: true },
        );
    }
                ...
                <View style={{ position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, justifyContent: 'center', alignItems: 'center', backgroundColor: '#F5F6F8' }}>
                    ...
                    <View style={{
                        ...
                        <TextInput style={styles.textInput} value={this.state.newEmail}
                            placeholder="New Email" autoCapitalize="none" secureTextEntry={false}
